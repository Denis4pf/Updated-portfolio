...
export default function Home({ publications }) {
  ...
  return (
    <div className="bg-white dark:bg-darker transition-all duration-150 ease-in-out">
      ...
      >
        <Head>
          <title>Denis Orina | Fullstack Developer & Designer</title>
          <meta
            name="description"
            content="The portfolio of Fullstack developer and designer, Denis Orina"
          />
            ...
            <nav className="block ml-auto">
              <ul className="z-50 flex flex-col items-start">
                ...
                <li className="z-40 block py-2 mt-6 list-none lg:inline-block">
                  <a
                    href={`mailto:dennisonwonga155@gmail.com`}
            ...
            <div className="container relative flex flex-col items-start justify-center flex-grow px-0 mx-auto md:px-20 lg:px-24 section">
              <div className="w-full">
                ...
                <p className="w-4/5 text-xl md:w-full">
                  ...
                  I design and develop high-quality code and create seamless user interfaces.
                </p>
                <button
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col-reverse items-start w-full md:flex-row">
                <div className="flex flex-col w-full md:pr-8 md:w-3/5">
                  <p className="text-lg">
                    Hello! I&apos;m Orina and I&apos;m a Fullstack developer,
          ...
          >
            ...
            <div className="flex flex-col w-full mb-12">
              ...
              <FeaturedProjectCard
                ...
                liveLink={"https://simple-shop-delta.vercel.app/"}
                repoLink={"https://github.com/Denis4pf/simple-shop"}
                stack={
                  <>
                    <Icon
                      IconType={Html}
             ...
             <FeaturedProjectCard
                ...
                imgWidth={"1366"}
                imgHeight={"666"}
                imgSrc={"/projects/profileme2.png"}
                liveLink={"https://habex.co.ke"}
                repoLink={null}
                stack={
                  <>
                    <Icon
